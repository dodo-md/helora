...
val disableReleaseSigning = providers.gradleProperty("helora.disableReleaseSigning")
    .getOrElse("false")
    .toBoolean()
...
val enableAbiSplits = providers.gradleProperty("helora.enableAbiSplits")
    .getOrElse("true")
    .toBoolean()

val enableComposeCompilerReports = providers.gradleProperty("helora.enableComposeCompilerReports")
    .getOrElse("false")
    .toBoolean()

@Suppress("DEPRECATION")
android {
    namespace = "com.dodoznq.helora"
    compileSdk = 37
    ...
    defaultConfig {
        applicationId = "com.dodoznq.helora"
        minSdk = 30
        targetSdk = 37
