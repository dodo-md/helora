...
-keepclassmembers class com.dodoznq.helora.data.model.** { *; }

-keep class com.google.gson.reflect.TypeToken { *; }
-keep class * extends com.google.gson.reflect.TypeToken

-keep class com.dodoznq.helora.data.preferences.PreferenceBackupEntry { *; }
-keep class com.dodoznq.helora.data.backup.model.** { *; }
-keep class com.dodoznq.helora.data.backup.module.** { *; }
-keep class com.dodoznq.helora.data.database.FavoritesEntity { *; }
-keep class com.dodoznq.helora.data.database.SongEngagementEntity { *; }
-keep class com.dodoznq.helora.data.database.LyricsEntity { *; }
-keep class com.dodoznq.helora.data.database.SearchHistoryEntity { *; }
-keep class com.dodoznq.helora.data.database.TransitionRuleEntity { *; }
