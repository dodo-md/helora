...
import com.dodoznq.helora.data.diagnostics.AdvancedPerformanceDiagnosticsController
...
import com.dodoznq.helora.presentation.viewmodel.LibraryStateHolder
import com.dodoznq.helora.presentation.viewmodel.ThemeStateHolder
...
import com.dodoznq.helora.utils.MediaMetadataRetrieverPool
...
@HiltAndroidApp
class HeloraApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var navidromeCoilFetcherFactory: dagger.Lazy<com.dodoznq.helora.data.image.NavidromeCoilFetcher.Factory>

    @Inject
    lateinit var jellyfinCoilFetcherFactory: dagger.Lazy<com.dodoznq.helora.data.image.JellyfinCoilFetcher.Factory>

    @Inject
    lateinit var localArtworkCoilFetcherFactory: dagger.Lazy<com.dodoznq.helora.data.image.LocalArtworkCoilFetcher.Factory>
    ...
    @Inject
    lateinit var syncManager: dagger.Lazy<com.dodoznq.helora.data.worker.SyncManager>
    ...
    override fun onCreate() {
        ...
        startupScope.launch {
            AlbumArtUtils.migrateLegacyCacheLocation(this@HeloraApplication)
