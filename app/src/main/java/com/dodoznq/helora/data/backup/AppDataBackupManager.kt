...
import com.dodoznq.helora.data.database.FavoritesEntity
import com.dodoznq.helora.data.database.LyricsDao
import com.dodoznq.helora.data.database.LyricsEntity
import com.dodoznq.helora.data.database.SearchHistoryDao
import com.dodoznq.helora.data.database.SearchHistoryEntity
import com.dodoznq.helora.data.database.SongEngagementEntity
    ...
    suspend fun exportToUri(
        ...
        runCatching {
            ...
            reportProgress(
                ...
                detail = "Your Helora backup was created successfully."
            )
        }
    }
