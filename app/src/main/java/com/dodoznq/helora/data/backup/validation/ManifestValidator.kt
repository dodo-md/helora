...
import com.dodoznq.helora.data.backup.model.Severity
...
class ManifestValidator @Inject constructor() {
     ...
     *
     * Strict by design: both [com.dodoznq.helora.data.backup.format.BackupWriter]
     * and [com.dodoznq.helora.data.backup.format.LegacyPayloadAdapter] always emit
