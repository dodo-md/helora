 ...
 * [com.dodoznq.helora.data.navidrome.model.NavidromeAuthMethod].
 *
 ...
 * @property clientId The client identifier sent to the server (default: "Helora")
 */
data class NavidromeCredentials(
    val serverUrl: String,
    val username: String,
    val password: String,
    val clientId: String = "Helora"
) {
    companion object {
        /**
