...
interface MusicRepository {
    ...
    fun getPaginatedAlbums(
        ...
        storageFilter: com.dodoznq.helora.data.model.StorageFilter = com.dodoznq.helora.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ...
    suspend fun getFavoriteSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.dodoznq.helora.data.model.SortOption = com.dodoznq.helora.data.model.SortOption.LikedSongTitleAZ,
        storageFilter: com.dodoznq.helora.data.model.StorageFilter = com.dodoznq.helora.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getSongsPage(
        limit: Int,
        offset: Int,
        sortOption: com.dodoznq.helora.data.model.SortOption = com.dodoznq.helora.data.model.SortOption.SongDefaultOrder,
        storageFilter: com.dodoznq.helora.data.model.StorageFilter = com.dodoznq.helora.data.model.StorageFilter.ALL
    ): List<Song>
    ...
    suspend fun getAlbumsPage(
        limit: Int,
        offset: Int,
        sortOption: com.dodoznq.helora.data.model.SortOption = com.dodoznq.helora.data.model.SortOption.AlbumTitleAZ,
        storageFilter: com.dodoznq.helora.data.model.StorageFilter = com.dodoznq.helora.data.model.StorageFilter.ALL,
        minTracks: Int = 1
    ): List<Album>
    ...
    suspend fun getArtistsPage(
        limit: Int,
        offset: Int,
        sortOption: com.dodoznq.helora.data.model.SortOption = com.dodoznq.helora.data.model.SortOption.ArtistNameAZ,
        storageFilter: com.dodoznq.helora.data.model.StorageFilter = com.dodoznq.helora.data.model.StorageFilter.ALL
    ): List<Artist>
     ...
     */
    fun getGenres(): Flow<List<com.dodoznq.helora.data.model.Genre>>
    ...
    fun getMusicFolders(
        storageFilter: com.dodoznq.helora.data.model.StorageFilter = com.dodoznq.helora.data.model.StorageFilter.ALL
    ): Flow<List<com.dodoznq.helora.data.model.MusicFolder>>
