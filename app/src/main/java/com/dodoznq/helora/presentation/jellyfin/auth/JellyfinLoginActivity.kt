...
import com.dodoznq.helora.presentation.components.CloudLibraryPickerItem
import com.dodoznq.helora.presentation.components.CloudLibraryPickerSheet
...
class JellyfinLoginActivity : ComponentActivity() {
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(com.dodoznq.helora.utils.AppLocaleManager.wrapContext(newBase))
    }
