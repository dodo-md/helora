...
import com.dodoznq.helora.data.database.AlbumArtThemeEntity
import com.dodoznq.helora.data.database.StoredColorSchemeValues
import com.dodoznq.helora.data.database.toComposeColor
import com.dodoznq.helora.utils.LocalArtworkUri
import com.dodoznq.helora.utils.traceAsyncSection
import com.dodoznq.helora.ui.theme.clearExtractedColorCache
import com.dodoznq.helora.ui.theme.extractSeedColor
import com.dodoznq.helora.ui.theme.generateColorSchemeFromSeed
        ...
        try {
            ...
            val schemePair = withContext(Dispatchers.Default) {
                val seed = extractSeedColor(
                    bitmap = bitmap,
                    config = com.dodoznq.helora.ui.theme.ColorExtractionConfig(
