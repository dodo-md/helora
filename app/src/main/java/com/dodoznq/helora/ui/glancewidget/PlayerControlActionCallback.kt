...
object PlayerActions {
    ...
    const val PLAY_PAUSE = "com.dodoznq.helora.ACTION_WIDGET_PLAY_PAUSE"
    const val NEXT = "com.dodoznq.helora.ACTION_WIDGET_NEXT"
    const val PREVIOUS = "com.dodoznq.helora.ACTION_WIDGET_PREVIOUS"
    const val FAVORITE = "com.dodoznq.helora.ACTION_WIDGET_FAVORITE"
    const val PLAY_FROM_QUEUE = "com.dodoznq.helora.ACTION_WIDGET_PLAY_FROM_QUEUE"
    const val SHUFFLE = "com.dodoznq.helora.ACTION_WIDGET_SHUFFLE"
    const val REPEAT = "com.dodoznq.helora.ACTION_WIDGET_REPEAT"
}
